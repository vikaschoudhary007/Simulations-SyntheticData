...
# Create a folder to save images and labels - provide full path
output_folder = 'AirSim/airsim_setup/AirSim_env/airsim_get_ground_truth'
...
# Function to save ground truth data
def save_ground_truth(position, orientation, count):
    filename = os.path.join(output_folder, f"ground_truth_{count}.txt")
...
def capture_data_during_flight():
    ...
    try:
        ...
        while True:
            ...
            # Get and save ground truth data
            ...
            ground_truth_filename = save_ground_truth(position, orientation, count)
